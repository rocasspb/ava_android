...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'kotlin.test.__convertKotlinClosureToJsClosure_(()->Js?)' : (f) => getCachedJsObject(f, () => wasmExports['__callFunction_(()->Js?)'](f, )),
    ...
    const wasmFilePath = './AvaAwaAnd-shared-test.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./AvaAwaAnd-shared-test.wasm',import.meta.url).href), importObject, { builtins: [''] })).instance;
      }
    } catch (e) {
