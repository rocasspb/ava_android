...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'korlibs.time.core.Date_now' : () => { return Date.now(); },
        'korlibs.time.core.Date_localTimezoneOffsetMinutes' : (rtime) => { return -(new Date(rtime)).getTimezoneOffset(); },
        ...
        'korlibs.platform.isDenoJs' : () => { return (typeof Deno === 'object' && Deno.statSync !== undefined) },
        'korlibs.platform.isWeb' : () => { return (typeof window === 'object') },
        'korlibs.platform.isNodeJs' : () => { return ((typeof process !== 'undefined') && process.release && (process.release.name.search(/node|io.js/) !== -1)) },
        'korlibs.platform.isWorker' : () => { return (typeof importScripts === 'function') },
        'korlibs.platform.denoEnvToObject' : () => { return Deno.env.toObject() },
        'korlibs.platform.jsObjectKeys' : (obj) => { return Object.keys(obj); },
        'korlibs.platform.jsObjectGet' : (obj, key) => { return obj ? obj[key] : null; },
        'korlibs.platform.Navigator_$external_fun' : () => new Navigator(),
        'korlibs.platform.userAgent_$external_prop_getter' : (_this) => _this.userAgent,
        'korlibs.platform.language_$external_prop_getter' : (_this) => _this.language,
        'korlibs.platform.languages_$external_prop_getter' : (_this) => _this.languages,
        'korlibs.platform.Navigator_$external_class_instanceof' : (x) => x instanceof Navigator,
        'korlibs.platform.Navigator_$external_class_get' : () => Navigator,
        'korlibs.platform.navigator_$external_prop_getter' : () => navigator,
        'korlibs.platform.Process_$external_fun' : () => new Process(),
        'korlibs.platform.platform_$external_prop_getter' : (_this) => _this.platform,
        'korlibs.platform.env_$external_prop_getter' : (_this) => _this.env,
        'korlibs.platform.Process_$external_class_instanceof' : (x) => x instanceof Process,
        'korlibs.platform.Process_$external_class_get' : () => Process,
        'korlibs.platform.process_$external_prop_getter' : () => process,
        'korlibs.platform.decodeURIComponent_$external_fun' : (p0) => decodeURIComponent(p0),
        'korlibs.wasm.jsEmptyObj' : () => { return {}; },
        'korlibs.wasm.eval' : (code) => { return eval(code); },
        'korlibs.wasm.jsObjectGet' : (obj, key) => { return obj ? obj[key] : null; },
        'korlibs.wasm.JsAny_set' : (obj, key, value) => { obj[key] = value; },
        'korlibs.wasm.JsAny_get' : (obj, key) => { return obj[key]; },
        'korlibs.wasm.JsFunction_$external_fun' : () => new Function(),
        'korlibs.wasm.apply_$external_fun' : (_this, p0, p1) => _this.apply(p0, p1),
        'korlibs.wasm.JsFunction_$external_class_instanceof' : (x) => x instanceof Function,
        'korlibs.wasm.JsFunction_$external_class_get' : () => Function,
        'korlibs.io.lang.runCatchingJsExceptions' : (block) => { try { return { result: block(), error: null }; } catch (e) { return { result: null, error: e }; } },
        'korlibs.io.lang.__convertKotlinClosureToJsClosure_(()->Js)' : (f) => getCachedJsObject(f, () => wasmExports['__callFunction_(()->Js)'](f, )),
        'korlibs.io.lang.TextDecoder_$external_fun' : (p0) => new TextDecoder(p0),
        'korlibs.io.lang.encoding_$external_prop_getter' : (_this) => _this.encoding,
        'korlibs.io.lang.decode_$external_fun' : (_this, p0) => _this.decode(p0),
        'korlibs.io.lang.TextDecoder_$external_class_instanceof' : (x) => x instanceof TextDecoder,
        'korlibs.io.lang.TextDecoder_$external_class_get' : () => TextDecoder,
        'korlibs.io.lang.TextEncoder_$external_fun' : (p0) => new TextEncoder(p0),
        'korlibs.io.lang.encoding_$external_prop_getter_1' : (_this) => _this.encoding,
        'korlibs.io.lang.encode_$external_fun' : (_this, p0) => _this.encode(p0),
        'korlibs.io.lang.TextEncoder_$external_class_instanceof' : (x) => x instanceof TextEncoder,
        'korlibs.io.lang.TextEncoder_$external_class_get' : () => TextEncoder,
        'korlibs.io.lang.result_$external_prop_getter' : (_this) => _this.result,
        'korlibs.io.lang.error_$external_prop_getter' : (_this) => _this.error,
        'korlibs.io.lang.JsError_$external_fun' : () => new Error(),
        'korlibs.io.lang.message_$external_prop_getter' : (_this) => _this.message,
        'korlibs.io.lang.JsError_$external_class_instanceof' : (x) => x instanceof Error,
        'korlibs.io.lang.JsError_$external_class_get' : () => Error,
        'korlibs.logger.JsConsole_$external_fun' : () => new Console(),
        'korlibs.logger.error_$external_fun' : (_this, p0) => _this.error(...p0),
        'korlibs.logger.warn_$external_fun' : (_this, p0) => _this.warn(...p0),
        'korlibs.logger.info_$external_fun' : (_this, p0) => _this.info(...p0),
        'korlibs.logger.log_$external_fun' : (_this, p0) => _this.log(...p0),
        'korlibs.logger.JsConsole_$external_class_instanceof' : (x) => x instanceof Console,
        'korlibs.logger.JsConsole_$external_class_get' : () => Console,
        'korlibs.logger.console_$external_prop_getter' : () => console,
        'korlibs.io.http.core.globalThisFetch' : (url, params) => globalThis.fetch(url, params),
        'korlibs.io.http.core.HeadersExt_$external_fun' : () => new HeadersExt(),
        'korlibs.io.http.core.keys_$external_fun' : (_this, ) => _this.keys(),
        'korlibs.io.http.core.HeadersExt_$external_class_instanceof' : (x) => x instanceof HeadersExt,
        'korlibs.io.http.core.HeadersExt_$external_class_get' : () => HeadersExt,
        'korlibs.io.dynamic.getJsGlobalDynamic' : () => { return ((typeof globalThis !== 'undefined') ? globalThis : ((typeof global !== 'undefined') ? global : self)); },
        'korlibs.io.dynamic.JsAny_get' : (obj, key) => { return obj[key]; },
        'korlibs.io.dynamic.JsAny_set' : (obj, key, value) => { obj[key] = value; },
        'korlibs.io.dynamic.JsAny_invoke' : (obj, key, args) => { obj[key].apply(obj, args); },
        'korlibs.io.runtime.JsNavigator_$external_fun' : () => new JsNavigator(),
        'korlibs.io.runtime.platform_$external_prop_getter' : (_this) => _this.platform,
        'korlibs.io.runtime.JsNavigator_$external_class_instanceof' : (x) => x instanceof JsNavigator,
        'korlibs.io.runtime.JsNavigator_$external_class_get' : () => JsNavigator,
        'korlibs.io.runtime.navigator_$external_prop_getter' : () => navigator,
        'korlibs.image.core.hasDocument' : () => { return (typeof document !== 'undefined') },
        'korlibs.image.core.getContext_$external_fun' : (_this, p0, p1) => _this.getContext(p0, ...p1),
