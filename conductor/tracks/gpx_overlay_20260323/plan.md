...
- [ ] Task: Define GPX Data Models (`GpxTrack`, `GpxPoint`, `GpxMetadata`)
- [ ] Task: Implement `GpxParser` using `XmlPullParser` to extract coordinates, name, distance, and elevation
