...
## Phase 2: UI Implementation [checkpoint: 79cfbb3]
...
- [x] Task: Conductor - User Manual Verification 'UI Implementation' (Protocol in workflow.md) [79cfbb3]

## Phase 3: Verification
- [x] Task: Add unit tests for avalanche data filtering logic in `MainViewModel`.
- [x] Task: Verify UI behavior with various avalanche bulletin scenarios.
