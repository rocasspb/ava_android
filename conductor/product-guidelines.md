...
## Tone & Messaging
- **Minimalist and Direct:** User communications should be concise, focusing on data delivery and iconography. Avoid unnecessary text to ensure clarity on the go.
...
## Accessibility
- **High Contrast and Readability:** UI elements, text, and icons must be optimized for maximum legibility in challenging outdoor lighting conditions, such as bright snow or low light.
