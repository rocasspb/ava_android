...
# Run unit tests (including Robolectric tests)
./gradlew test
...
./gradlew connectedDebugAndroidTest -Pandroid.testInstrumentationRunnerArguments.class=com.package.TestClassName
```
